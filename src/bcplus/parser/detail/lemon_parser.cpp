...
#line 30 "bcplus/parser/detail/lemon_parser.c"
...
typedef union {
  ...
  IncludeStatement::FilenameList* yy79;
  UNUSED yy115;
  Token const* yy155;
  Statement const* yy179;
  int yy247;
} YYMINORTYPE;
#ifndef YYSTACKDEPTH
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    15,   11,   12,   13,    7,   32,    2,    5,   17,   16,
 /*    10 */    18,    4,    8,    1,    3,   14,   33,   33,   33,   33,
 /*    20 */    10,   33,   33,   33,   33,   33,   33,    9,   33,   33,
 /*    30 */    33,   33,   33,   33,   33,   33,   33,   33,   33,   33,
 /*    40 */    33,   33,   33,   33,   33,   33,   33,   33,    6,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */    71,    1,    2,    3,  115,  116,  117,   66,  118,  119,
 /*    10 */     0,  120,  121,   12,  122,  121,  123,  123,  123,  123,
 /*    20 */    91,  123,  123,  123,  123,  123,  123,   98,  123,  123,
 /*    30 */   123,  123,  123,  123,  123,  123,  123,  123,  123,  123,
 /*    40 */   123,  123,  123,  123,  123,  123,  123,  123,  107,
};
...
static const signed char yy_reduce_ofst[] = {
 /*     0 */  -111, -109, -110, -106, -108,
};
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    19,   31,   31,   31,   31,   31,   31,   20,   24,   30,
 /*    10 */    29,   28,   27,   26,   25,   23,   22,   21,
};
...
** None.
*/
void lemon_parserTrace(FILE *TraceFILE, char *zTracePrompt){
...
static const char *const yyTokenName[] = { 
  ...
  "F2LP_GR",       "F2LP_CP",       "COMMENT",       "CONSTANTS",   
  "INCLUDE",       "MACROS",        "OBJECTS",       "QUERY",       
  "SHOW",          "SORTS",         "VARIABLES",     "ABACTION",    
  "ACTION",        "ADDITIVEACTION",  "ADDITIVEFLUENT",  "AFTER",       
  ...
  "PIPE",          "TILDE",         "DBL_COLON",     "ARROW_LEQ",   
  ...
  "AMP",           "DBL_AMP",       "COMMA",         "NOT",         
  "DASH",          "PLUS",          "DBL_GTHAN",     "STAR",        
  "INT_DIV",       "MOD",           "UMINUS",        "EOF",         
  "ERR_IO",        "ERR_UNKNOWN_SYMBOL",  "ERR_UNTERMINATED_STRING",  "ERR_UNTERMINATED_ASP",
  "ERR_UNTERMINATED_LUA",  "ERR_UNTERMINATED_F2LP",  "ERR_UNTERMINATED_BLK_COMMENT",  "error",       
  "start",         "statement_list",  "statement",     "incl_stmt",   
  "incl_lst",      "incl_item",     "incl_sep",    
};
#endif /* NDEBUG */
...
static const char *const yyRuleName[] = {
 /*   0 */ "start ::= statement_list EOF",
 /*   1 */ "statement_list ::=",
 /*   2 */ "statement_list ::= error",
 /*   3 */ "statement_list ::= statement_list statement",
 /*   4 */ "statement ::= incl_stmt",
 /*   5 */ "incl_stmt ::= COLON_DASH INCLUDE incl_lst PERIOD",
 /*   6 */ "incl_lst ::= incl_item",
 /*   7 */ "incl_lst ::= incl_lst incl_sep incl_item",
 /*   8 */ "incl_item ::= STRING_LITERAL",
 /*   9 */ "incl_item ::= IDENTIFIER",
 /*  10 */ "incl_item ::= INTEGER",
 /*  11 */ "incl_sep ::= SEMICOLON",
 /*  12 */ "incl_sep ::= COMMA",
};
#endif /* NDEBUG */
...
static void yy_destructor(
  ...
  switch( yymajor ){
    ...
    */
    ...
    case 19: /* ABACTION */
    case 20: /* ACTION */
    case 21: /* ADDITIVEACTION */
    case 22: /* ADDITIVEFLUENT */
    case 23: /* AFTER */
    case 24: /* ALWAYS */
    case 25: /* ASSUMING */
    case 26: /* ATTRIBUTE */
    ...
    case 32: /* DECREMENTS */
    case 33: /* DEFAULT */
    case 34: /* EXTERNALACTION */
    case 35: /* EXOGENOUS */
    case 36: /* EXOGENOUSACTION */
    case 37: /* IF */
    case 38: /* IFCONS */
    case 39: /* INCREMENTS */
    case 40: /* INERTIAL */
    case 41: /* INERTIALFLUENT */
    case 42: /* LABEL */
    case 43: /* MAY_CAUSE */
    case 44: /* MAXADDITIVE */
    case 45: /* MAXAFVALUE */
    case 46: /* MAXSTEP */
    case 47: /* NEVER */
    case 48: /* NOCONCURRENCY */
    case 49: /* STRONG_NOCONCURRENCY */
    case 50: /* NONEXECUTABLE */
    case 51: /* OF */
    case 52: /* POSSIBLY_CAUSED */
    case 53: /* RIGID */
    case 54: /* SDFLUENT */
    case 55: /* SIMPLEFLUENT */
    case 56: /* EXTERNALFLUENT */
    case 57: /* UNLESS */
    case 58: /* WHERE */
    case 59: /* FALSE */
    case 60: /* NONE */
    ...
    case 107: /* EOF */
    case 108: /* ERR_IO */
    case 109: /* ERR_UNKNOWN_SYMBOL */
    case 110: /* ERR_UNTERMINATED_STRING */
    case 111: /* ERR_UNTERMINATED_ASP */
    case 112: /* ERR_UNTERMINATED_LUA */
    case 113: /* ERR_UNTERMINATED_F2LP */
    case 114: /* ERR_UNTERMINATED_BLK_COMMENT */
{
#line 137 "bcplus/parser/detail/lemon_parser.y"
 delete (yypminor->yy0);								
#line 551 "bcplus/parser/detail/lemon_parser.c"
}
      break;
    case 116: /* start */
    ...
    case 122: /* incl_sep */
{
#line 140 "bcplus/parser/detail/lemon_parser.y"
 /* Intentionally left blank */			
#line 560 "bcplus/parser/detail/lemon_parser.c"
}
      break;
    case 118: /* statement */
    case 119: /* incl_stmt */
{
#line 145 "bcplus/parser/detail/lemon_parser.y"
 delete (yypminor->yy179);								
#line 568 "bcplus/parser/detail/lemon_parser.c"
}
      break;
    case 120: /* incl_lst */
{
#line 151 "bcplus/parser/detail/lemon_parser.y"
 delete (yypminor->yy79);								
#line 575 "bcplus/parser/detail/lemon_parser.c"
}
      break;
    case 121: /* incl_item */
{
#line 153 "bcplus/parser/detail/lemon_parser.y"
 delete (yypminor->yy155);								
#line 582 "bcplus/parser/detail/lemon_parser.c"
}
      break;
...
#line 163 "bcplus/parser/detail/lemon_parser.y"
{
  yy_destructor(yypParser,107,&yymsp[0].minor);
}
#line 900 "bcplus/parser/detail/lemon_parser.c"
        break;
      case 3: /* statement_list ::= statement_list statement */
#line 168 "bcplus/parser/detail/lemon_parser.y"
{
			ref_ptr<const Statement> ptr = yymsp[0].minor.yy179;
			parser->_handle_stmt(yymsp[0].minor.yy179);
		}
#line 908 "bcplus/parser/detail/lemon_parser.c"
        break;
      case 4: /* statement ::= incl_stmt */
#line 180 "bcplus/parser/detail/lemon_parser.y"
{
			yygotominor.yy179 = yymsp[0].minor.yy179;
		}
#line 915 "bcplus/parser/detail/lemon_parser.c"
        break;
      case 5: /* incl_stmt ::= COLON_DASH INCLUDE incl_lst PERIOD */
#line 189 "bcplus/parser/detail/lemon_parser.y"
{
			ref_ptr<IncludeStatement::FilenameList> lst_ptr = yymsp[-1].minor.yy79;
			yygotominor.yy179 = new IncludeStatement(yymsp[-1].minor.yy79, yymsp[-3].minor.yy0->begin(), yymsp[0].minor.yy0->end() );
...
#line 931 "bcplus/parser/detail/lemon_parser.c"
        break;
      case 6: /* incl_lst ::= incl_item */
#line 202 "bcplus/parser/detail/lemon_parser.y"
{
			yygotominor.yy79 = new IncludeStatement::FilenameList();
			yygotominor.yy79->push_back(yymsp[0].minor.yy155->str());
			delete yymsp[0].minor.yy155;
		}
#line 940 "bcplus/parser/detail/lemon_parser.c"
        break;
      case 7: /* incl_lst ::= incl_lst incl_sep incl_item */
#line 209 "bcplus/parser/detail/lemon_parser.y"
{
			yygotominor.yy79 = yymsp[-2].minor.yy79;
			yygotominor.yy79->push_back(yymsp[0].minor.yy155->str());
			delete yymsp[0].minor.yy155;
		}
#line 949 "bcplus/parser/detail/lemon_parser.c"
        break;
      case 8: /* incl_item ::= STRING_LITERAL */
      case 9: /* incl_item ::= IDENTIFIER */ yytestcase(yyruleno==9);
      case 10: /* incl_item ::= INTEGER */ yytestcase(yyruleno==10);
#line 216 "bcplus/parser/detail/lemon_parser.y"
{
			yygotominor.yy155 = yymsp[0].minor.yy0;
		}
#line 958 "bcplus/parser/detail/lemon_parser.c"
        break;
      case 11: /* incl_sep ::= SEMICOLON */
#line 228 "bcplus/parser/detail/lemon_parser.y"
{
  yy_destructor(yypParser,91,&yymsp[0].minor);
}
#line 965 "bcplus/parser/detail/lemon_parser.c"
        break;
      case 12: /* incl_sep ::= COMMA */
#line 229 "bcplus/parser/detail/lemon_parser.y"
{
  yy_destructor(yypParser,98,&yymsp[0].minor);
}
#line 972 "bcplus/parser/detail/lemon_parser.c"
        break;
      default:
      /* (1) statement_list ::= */ yytestcase(yyruleno==1);
      /* (2) statement_list ::= error */ yytestcase(yyruleno==2);
        break;
  };
...
#line 157 "bcplus/parser/detail/lemon_parser.y"
 parser->_parse_error("Syntax error.");	
#line 1038 "bcplus/parser/detail/lemon_parser.c"
  lemon_parserARG_STORE; /* Suppress warning about unused %extra_argument variable */
}
