/* Generated by re2c 0.13.6 on Mon May  5 23:55:04 2014 */
...
yy3_5:
	++source->cursor();
yy3_6:
#line 584 "bcplus/parser/detail/Scanner.3.re2c"
	{ 												goto yyc_ARG;						}
#line 174 "<stdout>"
yy3_7:
	++source->cursor();
#line 562 "bcplus/parser/detail/Scanner.3.re2c"
	{ 
...
yy3_13:
	++source->cursor();
#line 519 "bcplus/parser/detail/Scanner.3.re2c"
	{ 
...
yy3_18:
	++source->cursor();
#line 547 "bcplus/parser/detail/Scanner.3.re2c"
	{
												  if (sgl_quote || dbl_quote || ln_cmt || blk_cmt) goto yyc_ARG;
												  if (repeat) {
													// 2nd comma
...
yy3_53:
		...
		++source->cursor();
#line 290 "bcplus/parser/detail/Scanner.3.re2c"
		{ 
...
yy3_59:
		...
		++source->cursor();
#line 298 "bcplus/parser/detail/Scanner.3.re2c"
		{ 
												  if (!ln_cmt && !blk_cmt && !sgl_quote && !dbl_quote) {
												 	 _cond = yycNORMAL; 
												 	 ret = T_ASP_CP; 
...
yy3_138:
		...
		++source->cursor();
#line 477 "bcplus/parser/detail/Scanner.3.re2c"
		{ 
												  if (!ln_cmt && !blk_cmt && !sgl_quote && !dbl_quote) {
													  _cond = yycNORMAL; 
													  ret = T_F2LP_CP; 
...
yy3_145:
		...
		++source->cursor();
#line 485 "bcplus/parser/detail/Scanner.3.re2c"
		{
												  if (!ln_cmt && !blk_cmt && !sgl_quote && !dbl_quote) { 
													  _cond = yycNORMAL; 
													  ret = T_F2LP_CP; 
...
yy3_151:
		++source->cursor();
#line 450 "bcplus/parser/detail/Scanner.3.re2c"
		{ 
												  BLK_FINISH(1);
												  ret = T_ERR_UNTERMINATED_F2LP;			
												  _cond = yycNORMAL;
...
yy3_153:
		++source->cursor();
yy3_154:
#line 457 "bcplus/parser/detail/Scanner.3.re2c"
		{												goto yyc_F2LP_GR;					}
#line 1009 "<stdout>"
yy3_155:
		++source->cursor();
...
yy3_160:
		++source->cursor();
#line 422 "bcplus/parser/detail/Scanner.3.re2c"
		{
												  if (!dbl_quote && !ln_cmt && !blk_cmt) sgl_quote = !sgl_quote;
												  goto yyc_F2LP_GR;
												}
...
yy3_184:
		++source->cursor();
#line 407 "bcplus/parser/detail/Scanner.3.re2c"
		{ 
												  BLK_FINISH(1);
...
yy3_227:
		++source->cursor();
yy3_228:
#line 360 "bcplus/parser/detail/Scanner.3.re2c"
		{												goto yyc_LUA_GR;					}
#line 1427 "<stdout>"
yy3_229:
		++source->cursor();
...
yy3_232:
		++source->cursor();
#line 322 "bcplus/parser/detail/Scanner.3.re2c"
		{
												  if (!dbl_quote && !ln_cmt && !blk_cmt) sgl_quote = !sgl_quote;
												  goto yyc_LUA_GR;
												}
...
yy3_241:
		++source->cursor();
#line 336 "bcplus/parser/detail/Scanner.3.re2c"
		{
												  if (!ln_cmt && !sgl_quote && !dbl_quote) {
													  blk_cmt = true;
												  }
...
yy3_256:
	++source->cursor();
#line 618 "bcplus/parser/detail/Scanner.3.re2c"
	{
...
yy3_258:
	++source->cursor();
yy3_259:
#line 627 "bcplus/parser/detail/Scanner.3.re2c"
...
yy3_262:
	++source->cursor();
#line 591 "bcplus/parser/detail/Scanner.3.re2c"
	{ 
												  if (!blk_cmt && !sgl_quote && !dbl_quote) ln_cmt = true;
												  goto yyc_MACRO;
												}
...
yy3_270:
	++source->cursor();
#line 586 "bcplus/parser/detail/Scanner.3.re2c"
	{
												  source->newline();
												  ln_cmt = false;
												  goto yyc_MACRO;
