/* Generated by re2c 0.13.6 on Thu Jul 31 20:04:04 2014 */
...
yy3_3:
	++source->cursor();
#line 579 "bcplus/parser/detail/Scanner.3.re2c"
	{
...
yy3_5:
	++source->cursor();
yy3_6:
#line 593 "bcplus/parser/detail/Scanner.3.re2c"
	{ 												goto yyc_ARG;						}
#line 178 "<stdout>"
yy3_7:
	++source->cursor();
...
yy3_260:
	++source->cursor();
#line 612 "bcplus/parser/detail/Scanner.3.re2c"
	{ 
...
yy3_262:
	++source->cursor();
#line 600 "bcplus/parser/detail/Scanner.3.re2c"
	{ 
												  if (!blk_cmt && !sgl_quote && !dbl_quote) ln_cmt = true;
												  goto yyc_MACRO;
												}
...
yy3_267:
	++source->cursor();
#line 620 "bcplus/parser/detail/Scanner.3.re2c"
	{
...
yy3_272:
	++source->cursor();
#line 604 "bcplus/parser/detail/Scanner.3.re2c"
	{
												  if (!ln_cmt && !sgl_quote && !dbl_quote) blk_cmt = true;
												  goto yyc_MACRO;
												}
...
yy3_274:
	++source->cursor();
#line 608 "bcplus/parser/detail/Scanner.3.re2c"
	{
...
yy3_279:
		++source->cursor();
yy3_280:
#line 640 "bcplus/parser/detail/Scanner.3.re2c"
		{ ret = T_ERR_UNKNOWN_SYMBOL;					goto re2c_finish;					}
#line 1773 "<stdout>"
yy3_281:
		++source->cursor();
...
#line 642 "bcplus/parser/detail/Scanner.3.re2c"
