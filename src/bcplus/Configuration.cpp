/* Generated by re2c 0.13.6 on Sat Jun  7 16:42:37 2014 */
...
yy18:
		++opt;
#line 105 "bcplus/Configuration.r2c"
		{ 
...
yy43:
		++opt;
#line 115 "bcplus/Configuration.r2c"
		{ 
												  val.assign(token, (size_t)(opt - token - 2));
												  val2 = opt; 
...
yy58:
		++opt;
#line 110 "bcplus/Configuration.r2c"
		{ 
												  val.assign(token, (size_t)(opt - token - 2));
												  val2 = opt; 
