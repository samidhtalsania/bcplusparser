/* Generated by re2c 0.13.6 on Thu Jul 10 21:00:15 2014 */
	...
	for (int i = 1; i < argc; i++) {
		...
		if (ret == Status::STAT_NEXT_ARG) {
			if (i < argc-1 || argv[i+1][0] == '-') {
				...
				std::cerr << "ERROR: Expected an option following \"" << argv[i+1] << "\"." << std::endl;
...
yy41:
#line 132 "bcplus/Configuration.r2c"
		{ 
												  EXTRACT_NAME_VAL;
...
#line 158 "bcplus/Configuration.r2c"
