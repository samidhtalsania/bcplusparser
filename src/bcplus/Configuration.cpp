/* Generated by re2c 0.13.5 on Fri Mar 28 22:57:45 2014 */
...
int Configuration::load(int argc, char const** argv) {
	...
	for (int i = 1; i < argc; i++) {
		if ((ret = parseOption(argv[i])) == Status::STAT_HELP 
			|| ret == Status::STAT_VERSION || ret == Status::STAT_BAD_ARG) return ret;
