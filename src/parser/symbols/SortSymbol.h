...
public:
	...
	typedef ReferencedWrapper<std::set<ref_ptr<const ObjectSymbol> > > ObjectList;
	...
	/// List of sorts
	typedef ReferencedWrapper<std::set<weak_ptr<SortSymbol> > > SortList;
...
private:
	...
	/*************************************************************************************/
	/// The sort's objects
	ref_ptr<ObjectList> _objects;

	/// The sort's supersorts
	ref_ptr<SortList> _supersorts;

	/// The sort's subsorts
	ref_ptr<SortList> _subsorts;
